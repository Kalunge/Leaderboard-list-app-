...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _createScores_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createScores.js */ \"./src/createScores.js\");\n/* harmony import */ var _getScores_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./getScores.js */ \"./src/getScores.js\");\n/* harmony import */ var _displayData_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./displayData.js */ \"./src/displayData.js\");\n/* harmony import */ var _alert_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./alert.js */ \"./src/alert.js\");\n\n\n\n\n\n\nconst submitButton = document.getElementById('button');\nconst refreshButton = document.getElementById('refresh');\n\nconst user = document.getElementById('name');\nconst score = document.getElementById('score');\n\nsubmitButton.addEventListener('click', async (e) => {\n  e.preventDefault();\n  if (user.value === '') {\n    (0,_alert_js__WEBPACK_IMPORTED_MODULE_4__.default)('player name', 'danger');\n    return;\n  }\n  if (score.value === '') {\n    (0,_alert_js__WEBPACK_IMPORTED_MODULE_4__.default)('score', 'danger');\n    return;\n  }\n  await (0,_createScores_js__WEBPACK_IMPORTED_MODULE_1__.default)(user.value, score.value);\n  user.value = '';\n  score.value = '';\n  window.location.href = './index.html';\n\n  await (0,_displayData_js__WEBPACK_IMPORTED_MODULE_3__.default)();\n});\n\nrefreshButton.addEventListener('click', async (e) => {\n  e.preventDefault();\n  window.location.href = './index.html';\n  await (0,_displayData_js__WEBPACK_IMPORTED_MODULE_3__.default)();\n});\n\ndocument.addEventListener('DOMContentLoaded', async () => {\n  await (0,_getScores_js__WEBPACK_IMPORTED_MODULE_2__.default)();\n  (0,_displayData_js__WEBPACK_IMPORTED_MODULE_3__.default)();\n});\n\n\n//# sourceURL=webpack://leaderboard-list-app-/./src/index.js?");
